...
"""
    Copy of paltax/InputConfigs/input_config_br.py, with three lines commented out (see below, marked M)
"""
...
def get_config():
    ...
    # cosmos_path = str(pathlib.Path(__file__).parent.parent.parent)        # M
    # cosmos_path += '/datasets/cosmos/cosmos_galaxies_train.npz'           # M
    config['all_models'] = {
        ...
        # 'all_source_models': (source_models.CosmosCatalog(cosmos_path),), # M
